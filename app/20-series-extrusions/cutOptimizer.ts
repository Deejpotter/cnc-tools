 ...
 *
 * Deprecated: optimizer logic moved to `app/extrusions-calculator/cutOptimizer.ts`.
 * This file is retained for compatibility but no longer contains the implementation.
 */
