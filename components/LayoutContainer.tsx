 ...
 * Updated: 15/05/25
 * Author: Deej Potter
 * Description: A consistent layout wrapper used across the application.
 * Provides standardized padding, margins, and structure for all pages.
 * Used to maintain consistent UI and improve maintainability.
 */
